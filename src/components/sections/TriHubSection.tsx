...
const TriHubSection = () => {
  ...
  return (
    <MotionWrap ref={targetRef} className="min-h-[175vh]">
      <div className="sticky top-24 left-0 w-full">
        ...
        <div className="max-w-6xl mx-auto relative h-[600px]">
          {/* Doha Card */}
          <motion.div 
            className="absolute top-0 left-1/2 -translate-x-1/2 w-[45%] lg:w-1/3"
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            <svg width="100%" height="100%" viewBox="0 0 1200 600" preserveAspectRatio="none">
              ...
              <motion.path d="M 600 160 V 380 L 200 450" fill="none" stroke="hsl(var(--primary))" strokeWidth="2" style={{ pathLength: capitalLine1Path }} />
              <motion.path d="M 600 160 V 380 L 1000 450" fill="none" stroke="hsl(var(--primary))" strokeWidth="2" style={{ pathLength: capitalLine2Path }} />
              <motion.text x="600" y="280" textAnchor="middle" fill="hsl(var(--foreground))" fontSize="16" style={{ opacity: capitalTextOpacity }}>
                Sovereign Capital & Mandate
              </motion.text>
              
              {/* Execution Loop Lines */}
              <motion.path d="M 270 510 C 450 580, 750 580, 930 510" fill="none" stroke="hsl(var(--accent))" strokeWidth="2" strokeDasharray="4 4" style={{ pathLength: executionLine1Path }} />
              <motion.text x="600" y="565" textAnchor="middle" fill="hsl(var(--foreground))" fontSize="14" style={{ opacity: executionTextOpacity }}>
                Deal Flow & Growth
              </motion.text>

              <motion.path d="M 930 490 C 750 420, 450 420, 270 490" fill="none" stroke="hsl(var(--accent))" strokeWidth="2" strokeDasharray="4 4" style={{ pathLength: executionLine2Path }} />
              <motion.text x="600" y="445" textAnchor="middle" fill="hsl(var(--foreground))" fontSize="14" style={{ opacity: executionTextOpacity }}>
